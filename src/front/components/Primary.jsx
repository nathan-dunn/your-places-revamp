...
class Primary extends Component {
  render() {
    ...
    return (
      <div className="myList ma2 pa2 center tc">
        {placeKeys.map((placeKey, i) => {
          ...
          return (
            <div
              className={`w-100 ma1 pa1 center flex justify-between bb b--white-30 items-center ${isHeader &&
                'b mt3'} ${isDeletion && 'border-none'}`}
              key={i}
            >
